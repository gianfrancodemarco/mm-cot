...
FAKEDDIT_VISION_FEATURES_DETR_TRAIN = os.path.join(FAKEDDIT_VISION_FEATURES_DETR_PATH, "train.npy")
FAKEDDIT_VISION_FEATURES_DETR_VALIDATION = os.path.join(FAKEDDIT_VISION_FEATURES_DETR_PATH, "validation.npy")
FAKEDDIT_VISION_FEATURES_DETR_TEST = os.path.join(FAKEDDIT_VISION_FEATURES_DETR_PATH, "test.npy")
